...
4. Enable the Arduino's main loop to ignore the clock while it performs other tasks.  
...
![Serial Monitor Example](https://github.com/IowaDave/RTC-DS3231-Arduino-Interrupt/blob/main/images/SerialMonitor.jpg)
